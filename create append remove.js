...
// Create and append a list with 3 items
let myList = document.createElement("ul");

for (let i = 1; i <= 3; i++) {
    let listitmes = document.createElement("li");
    listitmes.textContent = "Item " + i;
    listitmes.style.color = "blue";
    listitmes.style.fontSize = "18px";
    myList.appendChild(listitmes); 
}

// Append the full list after the loop
